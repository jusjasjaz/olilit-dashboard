...
export class SidebarComponent implements OnInit {
  ...
  loadMenu(){
    MENU.map(((data:any)=>{
      if( this.access.permissions[data.label] && this.access.permissions[data.label].includes('R') ) {
        let lbl = '';
        switch (data.label.toLowerCase()) {
          case 'panel de control': case 'dashboard': lbl = 'SIDEBAR.text1'; break;
          case 'clientes': case 'customers': lbl = 'SIDEBAR.text2'; break;
          case 'establecimientos': case 'merchants': lbl = 'SIDEBAR.text3'; break;
          case 'manejo del usuario': case 'user management': lbl = 'SIDEBAR.text4'; break;
          case 'fee configuration': lbl = 'SIDEBAR.text5'; break;
          case 'limit configuration': lbl = 'SIDEBAR.text6'; break;
          case 'help ticket': lbl = 'SIDEBAR.text7'; break;
        }
        this.translate.get(lbl).subscribe((text:string) => { 
          data.label = text;
